...
%%
                                                        ...
                                                        % by the system
Sys.stl_list = {'ev_[0,1.] alw_[0,2] (abs(y1(t)-w1(t)) < 0.01)'}; % epsilon less shows Yalmip error, too bad a disturbance           
...
Sys.stl_list = {'alw (ev_[0,1.] alw_[0,0.5] ( abs(y1(t)-w1(t)) < 3))'}; % epsilon< 3, around, shows Yalmip error, too bad a disturbance
